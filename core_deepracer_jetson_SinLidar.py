...
Version SinLidar: en modo sin trayectoria usa throttle_o de ARTEMIS
como velocidad base, no lidar_throttle_control.
...
def main():
    ...
    print(
        "[CORE SPLIT] Sin trayectoria throttle: "
    ...
    while True:
        ...
        no_road_throttle = artemis_base_throttle(auto_utils)
        ...
        if manual_control_active:
            if control_mode in (1, 3):
                ...
                control_acelerador = no_road_throttle
